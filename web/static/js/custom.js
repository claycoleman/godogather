...
$('.event-detail').on('click', '.confirm-can-come', function(e) {
    ...
    $.ajax({
        ...
        success: function(data) {
            $("#event-detail-"+prk).html('<br><img style="max-height: 40px; max-width: 40px; float:left; border-radius: 20px;" src="' + data[4] + '"><h4 style="float: left;"><strong class="black">&nbsp;' + data[1] + '</strong></h4><h5 class="darkgrey" style="float: right;">Posted <span class="date-posted">' + data[5] + '</span></h5><br style="clear:both;"><h2 class="text-center"><a href="/events/' + prk +'">' + data[0] + '</a></h2><div class="row"><div class="col-md-4"><h4 class="date-starting">' + data[2] + '</h4><h5>' + data[3] + '</h5></div><div class="col-md-8 text-right"><h3>' + data[6] + '</h3></div></div><div class="text-right" style="float:right;"><span class="green stan"><i class="fa fa-check-circle"></i>&nbsp;&nbsp;You\'re going!</span>&nbsp;&nbsp;<a class="btn btn-danger cancel-decision" id="reject-button-' + prk + '" alt="' + prk + '"  href="#"><i class="fa fa-times-circle" alt="' + prk + '" id="' + prk + '"></i>&nbsp;&nbsp;Back out...</a></div></div><br><br>');
